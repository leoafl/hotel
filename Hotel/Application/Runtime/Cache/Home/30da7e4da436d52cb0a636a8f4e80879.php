            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        ...
                        <table id="table">
                            <?php if(is_array($resd)): $i = 0; $__LIST__ = $resd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$resd): $mod = ($i % 2 );++$i;?><thead>
                                <tr>
                                    <th>订单号</th>
                                    <th>入住时间</th>
                                    <th>离店时间</th>
                                ...
                                <tr>
                                    <td><?php echo ($resd["oid"]); ?></td>
                                    <td><?php echo ($resd["ogtime"]); ?></td>
                                    <td><?php echo ($resd["oltime"]); ?></td>
                                    <td><?php echo ($resd["rname"]); ?></td>
                                    <td><?php echo ($resd["rprice"]); ?></td>
                                    <td>
                                        <!--<a href="<?php echo U('personal/order');?>" style="color: #ff7900">点击查看</a>-->
                                        <a href="<?php echo U('personal/ordermsg',array('Oid'=>$resd['oid']));?>" style="color: #ff7900">点击查看</a>
                                    </td>
                                    <td>
                                        ...
                                        <a class="layui-btn layui-btn-warm layui-btn-sm"
                                           onclick="showDel('<?php echo ($resd["oid"]); ?>','<?php echo ($resd["rname"]); ?>')">删除</a>
                                    </td>
...
<script>
    ...
    function showDel(name, Oid) {
        ...
        layer.confirm("确认删除" + name + "号订单"+"?", {
            ...
            location.href='delete?no=<?php echo ($resd["oid"]); ?>';
        });
    }
