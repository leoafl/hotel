            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;">待评价订单</a></dd>
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <ul>
                            ...
                            <li style="padding-bottom: 10px">手机号：<?php echo ($order['uphone']); ?></li>
                            ...
                            <li style="padding-bottom: 10px">价格：<b style="color:#f60;font-size: 16px"><?php echo ($order['rprice']); ?></b></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                </div>
            </div>
