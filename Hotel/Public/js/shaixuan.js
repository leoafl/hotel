...
var oClearList = $151(".hasBeenSelected .clearList");
...
oSelectList.onclick = function(e, a) {
    ...
    var infor = '';
    var aRadio = document.getElementsByName('rprice');
...
$151('div.eliminateCriteria').click(function(){
    $151(oSelectList).find('input').attr('checked',false);
    radioVal = '';
    isCusPrice = false;
    okSelect.length = 0;
    $151(oSelectList).trigger('click', 1);
})

$151('.clearList').find('em').live('click',function(){
    var self = $151(this);
    ...
    delStr(val, okSelect);
    $151(oSelectList).trigger('click', a);
