        ...
        <div class="htmleaf-container">
            <div class="wrapper">
                <div class="container">
                    ...
                    <form>
                        <input type="text" name="Uname" placeholder="请输入账号" v-model="username">
                        <input type="password" name="Upassword" placeholder="请输入密码" v-model="password">
                        <input type="text" name="Uemail" placeholder="请输入邮箱" v-model="email">
                        <input type="button" value="注册" class="register" @click="register"/>
                        <div class="footer-word">注册成功之后说明您已成为我们的顾客，我们将为您提供更多的服务</div>
                    </form>
                </div>
                <ul class="bg-bubbles">
                    <li></li>
...
export default {
  ...
  methods: {
    register () {
      axios.post('/home/register/userRegister', {
