            ...
            <div class="wrapper">
                <div class="container">
                    ...
                    <form>
                        ...
                        <input type="password" name="userPassword" placeholder="请输入密码" v-model="password">
                       ...
                       <div class="login-bottom">
                        ...
                        <div class="footer">
                            ...
                            <span class="footer-word">登陆代表你已经同意文津酒店用户协议、隐私政策</span>
                        </div>
                    </form>
                </div>
...
export default {
  ...
  methods: {
    login () {
      axios.post('/home/Login/userLogin', {
        ...
        .then((response) => {
          ...
          if (data.code < 0) {
            ...
            // window.location.href = 'http://localhost/untitled/Hotel/index.php/home/homepage/index.html'
          }
